...
namespace AddressBook.Controllers
{
    ...
    public class AddressBookController : ControllerBase
    {
        ...
        [HttpGet]
        public ActionResult<ResponseModelSMD<IEnumerable<AddressBookEntity>>> GetAllContacts()
        {
        ...
        [HttpGet("{id}")]
        public ActionResult<ResponseModelSMD<ResponseUserModel>> GetContactById(int id)
        {
        ...
        [HttpPost]
        public ActionResult<ResponseModelSMD<ResponseUserModel>> AddContact([FromBody] ResponseUserModel request)
        {
        ...
        [HttpPut("{id}")]
        public ActionResult<ResponseModelSMD<ResponseUserModel>> UpdateContact(int id, [FromBody] ResponseUserModel request)
        {
        ...
        [HttpDelete("{id}")]
        public ActionResult<ResponseModelSMD<string>> DeleteContact(int id)
        {
